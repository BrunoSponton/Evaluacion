...
namespace Apuestas.FE
{
    public partial class Form1 : Form
    {
        ...
        private void btApostar1_Click_1(object sender, EventArgs e)
        {
        ...
        private void btApostar2_Click1(object sender, EventArgs e)
        {
            seRealizoApuesta = true;
        ...
        private void btApostar3_Click1(object sender, EventArgs e)
        {
            seRealizoApuesta = true;
        ...
        private void btApostar4_Click1(object sender, EventArgs e)
        {
            seRealizoApuesta = true;
        ...
        private void btApostar5_Click1(object sender, EventArgs e)
        {
            seRealizoApuesta = true;
